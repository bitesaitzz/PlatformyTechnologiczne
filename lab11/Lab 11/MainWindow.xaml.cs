...
namespace Lab_11
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void NewtonSymbolTasks(object sender, RoutedEventArgs e)
        {
            ...
            {
                SetErrorLabel("Error: Enter integers K and N");
                return;
            }
            ...
            {
                 case -1:
                    SetErrorLabel("Error: N and K should be greater than 0");
                    break;
                case -2:
                    SetErrorLabel("Error: K > N");
                    break;
                default:
        ...
        public void Fibonacci(object sender, RoutedEventArgs e)
        {
            ...
            {
                SetErrorLabel("Error: Enter number");
            }

            if (i <= 0)
            {
                SetErrorLabel("Error: it should be greater than 0");
                return;
            }
